...
router.post("/add-brochure",upload.single("file"),(req, res) => brochureController.addBrochure(req, res)); 
...
router.patch("/edit-brochure/:id",upload.single("file"),(req, res) => brochureController.editBrochure(req, res));
